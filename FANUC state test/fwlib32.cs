...
namespace YCM
{
    ...
    public class ODBMDIP
    {
        ...
        public class OFS_1
        {
           ...
           MarshalAs(UnmanagedType.ByValArray, SizeConst = 1600)]
            public int[] m_ofs = new int[1600];     /* M Each */
            [FieldOffset(0),
           MarshalAs(UnmanagedType.ByValArray, SizeConst = 1600)]
            public int[] m_ofs_a = new int[1600];   /* M-A All */
            [FieldOffset(0),
           MarshalAs(UnmanagedType.ByValArray, SizeConst = 1600)]
            public short[] t_tip = new short[1600];   /* T Each, 2-byte */
            [FieldOffset(0),
           MarshalAs(UnmanagedType.ByValArray, SizeConst = 1600)]
            public int[] t_ofs = new int[1600];     /* T Each, 4-byte */
        ...
        public class IODBZOFS
        {
            ...
            public int[] data = new int[32];       /* data value */
        }
    ...
    public class REALPRMS
    {
        ...
        public class ALM_HIS5_data
        {
            ...
            public int[] g_modal;        /* G code Modal */
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 10)]
            public char[] g_dp;           /* #7:1 Block  #6Å`#0 dp */
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 10)]
            public int[] a_modal;        /* B,D,E,F,H,M,N,O,S,T code Modal */
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 10)]
            public char[] a_dp;           /* #7:1 Block  #6Å`#0 dp */
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 32)]
            public int[] abs_pos;        /* Abs pos */
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 32)]
            public char[] abs_dp;         /* Abs dp */
